 ...
 * @version 30/03/2015
 */
public class NamingCSAction extends CSAction
{
    static public final String CODE = "naming";
    static public final String CSCODE = "name.invalidPattern";
     ...
     */
    public NamingCSAction(String cde, int maxp)
    {
        super(cde, maxp);
        errors = 0;
        //setPoints();
